...
void CommonStyle::addQtControlStyle(QStringList &list)
{
    ...
    //滚动条去掉右键菜单
    list << QString("QScrollBar{qproperty-contextMenuPolicy:NoContextMenu;}");
    ...
    //日历面板/到Qt6才修复SingleLetterDayNames的bug
    list << QString("QCalendarWidget{qproperty-firstDayOfWeek:Sunday}");
    list << QString("QCalendarWidget{qproperty-horizontalHeaderFormat:SingleLetterDayNames}");
#endif
