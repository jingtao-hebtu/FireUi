...
public:
    ...
    //获取通用sqlite数据库文件
    static QString getDbDefaultFile(const QString &path = QString(), const QString &name = QString());
    ...
    //获取所有数据库用户表
    static QStringList getTables(const QString &dbName, const QString &dbType,
