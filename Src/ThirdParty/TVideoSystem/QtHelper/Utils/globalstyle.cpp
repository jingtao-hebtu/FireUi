...
QString GlobalStyle::getStyle(const QString &qssFile, bool getQssColor) {
    ...
    if (getQssColor && !qss.isEmpty()) {
        GlobalStyle::getQssColor(qss, GlobalConfig::TextColor, GlobalConfig::PanelColor, GlobalConfig::BorderColor,
                                 GlobalConfig::NormalColorStart,
                                 GlobalConfig::NormalColorEnd, GlobalConfig::DarkColorStart, GlobalConfig::DarkColorEnd,
                                 GlobalConfig::HighColor);
    }
...
void GlobalStyle::setStyleFile(const QString &qssFile, QString &textColor, QString &panelColor, QString &borderColor,
    ...
    if (!qss.isEmpty()) {
        getQssColor(qss, textColor, panelColor, borderColor, normalColorStart, normalColorEnd, darkColorStart,
                    darkColorEnd, highColor);
        setStyle(qss);
    }
}
