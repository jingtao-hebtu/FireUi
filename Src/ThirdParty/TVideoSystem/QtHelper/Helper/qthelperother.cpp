...
void
QtHelperOther::setSystemDateTime(const QString &year, const QString &month, const QString &day, const QString &hour,
...
QVector<QString> QtHelperOther::msgKeys =
        QVector<QString>() << QString::fromUtf8("发送") << QString::fromUtf8("接收") << QString::fromUtf8("解析")
                           << QString::fromUtf8("错误") << QString::fromUtf8("提示");
QVector<QColor> QtHelperOther::msgColors =
...
QString QtHelperOther::appendMsg(QTextEdit *textEdit, int type, const QString &data, int maxCount, int &currentCount,
                                 bool clear, bool pause) {
    if (clear) {
        textEdit->clear();
        currentCount = 0;
        return QString();
...
void QtHelperOther::search(QTreeWidget *treeWidget, const QString &key, int level) {
    //找到所有匹配的节点
