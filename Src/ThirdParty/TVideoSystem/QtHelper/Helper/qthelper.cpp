...
QWidget *QtHelper::centerBaseForm = NULL;

void QtHelper::setFormInCenter(QWidget *form, bool sizeHint) {
    QtHelperCore::setFormInCenter(form, centerBaseForm, sizeHint);
}
...
QString QtHelper::getOpenFileName(const QString &filter, const QString &dirName, const QString &fileName, bool native,
                                  int width, int height) {
    return QtHelperFile::getOpenFileName(filter, dirName, fileName, native, width, height);
}

QString QtHelper::getSaveFileName(const QString &filter, const QString &dirName, const QString &fileName, bool native,
                                  int width, int height) {
...
void QtHelper::setSystemDateTime(const QString &year, const QString &month, const QString &day, const QString &hour,
                                 const QString &min, const QString &sec) {
...
QString
QtHelper::appendMsg(QTextEdit *textEdit, int type, const QString &data, int maxCount, int &currentCount, bool clear,
                    bool pause) {
...
void QtHelper::search(QTreeWidget *treeWidget, const QString &key, int level) {
    QtHelperOther::search(treeWidget, key, level);
}
