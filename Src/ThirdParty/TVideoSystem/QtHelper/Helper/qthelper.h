...
public:
    ...
    static void setFormInCenter(QWidget *form, bool sizeHint = false);
    ...
    static QString
    getIniValue(char *argv[], const QString &key, const QString &dir = QString(), const QString &file = QString());
    ...
    //弹出中间提示框
    static void
    showSplashInfo(const QString &text, int fontSizeMain, int fontSizeSub, int timeout = 0, bool exec = false);
    ...
    //树节点匹配关键字
    static void search(QTreeWidget *treeWidget, const QString &key, int level = 5);
};
