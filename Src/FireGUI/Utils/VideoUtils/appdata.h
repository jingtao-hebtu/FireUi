...
public:
    ...
    static QString MarkerImage;         //标注点图标
    static int MarkerWidth;             //标注点宽度
    static int MarkerHeight;            //标注点高度
    ...
    static QStringList BtnMainTexts;    //主界面顶部按钮名称
    static QStringList BtnConfigTexts;  //系统设置按钮名称    
